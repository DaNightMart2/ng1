...
function bombUnloaded() {
    const bombs = dimension.getEntities({ "type": "ng1:bomb" });
...
function screenUnloaded() {
    const screens = dimension.getEntities({ "type": "ng1:screen" });
...
function keepWoodenDoorOpen() {
    const wooden_doors = dimension.getEntities({ "type": "ng1:wooden_door" });
...
function playPeterJonsonIdleAnimation() {
    if (animationCooldown <= 0) {
        const peter_jonsons = dimension.getEntities({ "type": "ng1:peter_jonson" });
